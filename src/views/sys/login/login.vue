<template>
    <div id="login">
        <div class="loginConbox">
            <div class="loginBox">
                <div class="loginCon">
                    <p class="title">后台管理系统模板</p>
                    <p class="title">vue + element-ui</p>
                    <el-card shadow="always" class="login-module" v-if="state">
                        <div slot="header" class="clearfix formTitlt">
                            <span>密码登录</span>
                            <span class="titIconbox">
                              <i class="iconfont xu-saomadenglu2 fa-lg iconcolor"></i>
                              <i class="iconfont xu-saomadenglu01 el-icon--right fa-lg pointer" @click="state = !state"></i>
                            </span>
                        </div>
                        <el-form :model="loginForm" :rules="rules" ref="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item>
                                <el-button class="subBtn" type="primary" @click="submitForm('ruleForm')">登录</el-button>
                            </el-form-item>
                            <p class="smalltxt">
                    ...
                    <el-card shadow="always" class="login-module" v-else>
                        <div slot="header" class="clearfix formTitlt">
                            ...
                            <span class="titIconbox">
                              ...
                              <i class="iconfont xu-imagevector el-icon--right fa-lg pointer" @click="state = !state"></i>
                            </span>
                        </div>
                        <div class="ewmbox">
                            <div class="ewm">
            ...
            submitForm (formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$common.setStore('loginState',true);
